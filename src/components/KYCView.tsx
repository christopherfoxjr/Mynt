  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 text-slate-900">
      <motion.div 
        ...
        className="w-full max-w-xl bg-white rounded-[48px] p-12 shadow-2xl border border-slate-100"
      >
        {step === 'welcome' && (
          <div className="text-center">
            ...
            <div className="space-y-4">
              ...
              <button 
                onClick={onBack}
                className="w-full bg-white border-2 border-slate-100 text-slate-400 py-5 rounded-[24px] text-lg font-bold flex items-center justify-center gap-3 active:scale-95 transition-all hover:bg-slate-50 hover:text-slate-600 hover:border-slate-200"
              >
                Back to Home
              </button>
            </div>
        ...
        {step === 'age' && (
          <div>
            <button 
              ...
              className="mb-6 flex items-center gap-2 text-slate-400 hover:text-slate-600 font-bold text-xs uppercase tracking-widest transition-colors"
            >
              <ArrowLeft size={16} />
              Back
            </button>
            ...
            <div className="space-y-6">
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-slate-50 border-2 border-slate-100 rounded-[24px] py-5 pl-16 pr-6 focus:border-emerald-500 focus:outline-none font-bold text-xl"
                />
              </div>
        ...
        {step === 'guardian' && (
          <div>
            ...
            <div className="mb-8 p-6 bg-blue-50 border border-blue-100 rounded-3xl flex gap-4">
            ...
            <div className="space-y-6">
              ...
              <button 
                ...
                className="w-full bg-emerald-600 text-white py-5 rounded-[24px] text-lg font-bold disabled:opacity-50 flex items-center justify-center gap-3"
              >
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-50 border-2 border-slate-100 rounded-[24px] py-5 pl-16 pr-6 focus:border-emerald-500 focus:outline-none font-bold text-xl italic font-display"
                  />
                </div>
              </div>
              <button 
        ...
        {step === 'redirecting' && (
          <div className="text-center py-12">
            ...
            <h2 className="text-2xl font-bold font-display mb-4 italic">Securing your vault...</h2>
            <p className="text-slate-400 font-medium whitespace-nowrap">Redirecting you to Stripe Identity for secure document scanning.</p>
          </div>
        )}
        ...
        {step === 'pending' && (
          <div className="text-center">
            ...
            <h1 className="text-4xl font-bold font-display mb-4 italic">Under Review</h1>
            <p className="text-slate-500 mb-10 text-lg leading-relaxed font-medium">
            ...
            <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100 flex flex-col gap-3">
              <div className="flex justify-between items-center text-sm">
                ...
                <span className="text-blue-600 font-bold bg-blue-50 px-3 py-1 rounded-full text-xs">Awaiting Approval</span>
              </div>
            ...
            <div className="flex flex-col gap-4 mt-10">
              <button 
                ...
                disabled={loading}
                className="bg-slate-900 text-white font-bold py-4 rounded-2xl text-sm uppercase tracking-widest hover:bg-slate-800 disabled:opacity-50 transition-all active:scale-95 shadow-lg"
              >
